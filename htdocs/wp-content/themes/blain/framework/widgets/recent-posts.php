...
class blain_Recent_Posts extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'blain_rp', // Base ID
            __('Blain Recent Posts with Thumbnails', 'blain'), // Name
    ...
    public function widget( $args, $instance ) {
        ...
        if($recent_articles->have_posts()) : ?>
            ...
            <?php esc_html_e('Oops, there are no posts.','blain') ?>
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_html($this->get_field_id( 'title') ); ?>"><?php esc_html_e( 'Title:','blain' ); ?></label>
            <input class="widefat" id="<?php echo esc_html($this->get_field_id( 'title') ); ?>" name="<?php echo esc_html($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />

            <label for="<?php echo esc_html($this->get_field_id( 'no_of_posts' )); ?>"><?php esc_html_e( 'No. of Posts:', 'blain' ); ?></label>
